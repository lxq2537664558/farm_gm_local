...
$chuanglan_config['api_send_url'] = 'http://smssh1.253.com/msg/send/json';//'http://xxx/msg/send/json';
...
//创蓝账号 替换成你自己的账号
$chuanglan_config['api_account']	= 'N4113273';

//创蓝密码 替换成你自己的密码
$chuanglan_config['api_password']	= 'qfOWwRrs87bf6f';
