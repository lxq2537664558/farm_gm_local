function checktable(issearch){
    $.ajax({
         url:ipaddress+"index.php?m=Agent&c=User&a=index",
         data : {
            ...
            if(data.data){
                ...
                if($('#group').val()!=2 && $('#group').val()!=3){
                    ...
                    $('.edit').click(function(){
                        ...
                        $.ajax({
                            url: ipaddress+`index.php?m=Agent&c=User&a=editUser&uid=${uid}`,
                            type: 'GET',
                            dataType: 'json',
                            success: function(data){
                                // 创建编辑html
                                ...
                                $('.sure_change').click(function(){
                                   // console.log(1);
                                    ...
                                    $.ajax({
                                        url : ipaddress+"index.php?m=Agent&c=User&a=editUser",
                                        data: {
                ...
                if($('#group').val()!=2){
                    ...
                    $('.delete_user').click(function(){
                        ...
                        if(r == true) {
                            ...
                            window.location=ipaddress+`index.php?m=Agent&c=User&a=deleteUser&uid=${uid}`
                        }else {
                            return false;
                        }
                    })
                ...
                $('.pending_order').click(function(){
                    var uid = $(this).parents('tr').find('td:nth-child(1) span').text();
                    var mid = $(this).parents('tr').find('td:nth-child(1) input').val();
                    window.location=ipaddress+`index.php?m=Agent&c=User&a=pendingOrder&uid=${uid}&mid=${mid}`
                })
                ...
                $('.gold_records').click(function(){
                    var uid = $(this).parents('tr').find('td:nth-child(1) span').text();
                    var mid = $(this).parents('tr').find('td:nth-child(1) input').val();
                    window.location=ipaddress+`index.php?m=Agent&c=User&a=goldRecords&uid=${uid}&mid=${mid}`
                })
                ...
                $('.promotion_list').click(function(){
                    var uid = $(this).parents('tr').find('td:nth-child(1) span').text();
                    var mid = $(this).parents('tr').find('td:nth-child(1) input').val();
                    window.location=ipaddress+`index.php?m=Agent&c=User&a=promotionList&uid=${uid}&mid=${mid}`
                })
                ...
                $('.items_list').click(function(){
                    var uid = $(this).parents('tr').find('td:nth-child(1) span').text();
                    var mid = $(this).parents('tr').find('td:nth-child(1) input').val();
                    window.location=ipaddress+`index.php?m=Agent&c=User&a=itemsList&uid=${uid}&mid=${mid}`
                })
            }else{
                alert("没有此查询数据");
                $('#left_page').hide();
