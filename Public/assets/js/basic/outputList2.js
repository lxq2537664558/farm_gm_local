...
$('.edit_submit').click(function(){
	$.ajax({
		url: ipaddress+"index.php?m=Home&c=Basic&a=editOutputList2",
		type: "POST",
		data: {
			mid : mid,
			...
			lv1LandMinorProbability : $('.edit_area p:nth-child(7) input').val(),
			lv1LandMinorNumber : $('.edit_area p:nth-child(8) input').val(),
			lv2LandMainProbability : $('.edit_area p:nth-child(9) input').val(),
			lv2LandMainNumber : $('.edit_area p:nth-child(10) input').val(),
			lv2LandMinorProbability : $('.edit_area p:nth-child(11) input').val(),
			lv2LandMinorNumber : $('.edit_area p:nth-child(12) input').val(),
			lv3LandMainProbability : $('.edit_area p:nth-child(13) input').val(),
			lv3LandMainNumber : $('.edit_area p:nth-child(14) input').val(),
			lv3LandMinorProbability : $('.edit_area p:nth-child(15) input').val(),
			lv3LandMinorNumber : $('.edit_area p:nth-child(16) input').val(),
		},
		dataType: "json",
