         ...
         success: function (data) {
            ...
            if(data.data){
                for(var i = 0; i<data.data.length; i++){
                    $('#mytable tbody').append(`<tr><td>${data.data[i].id}</td><td>${data.data[i].product_id}</td><td>${data.data[i].product_name}</td><td>${data.data[i].order_type}</td><td>${data.data[i].order_num}</td><td>${data.data[i].price}</td><td>${data.data[i].order_time}</td><td>${data.data[i].order_state}</td><td>${data.data[i].end_time}</td><td>${data.data[i].sell_num}</td><td>${data.data[i].trade_uid}</td></tr>`)
                }
                // 分页以及搜索
                $('#search').show();
                $('#left_page').show();
